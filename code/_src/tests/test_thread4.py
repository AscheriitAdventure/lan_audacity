...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        btn_3 = QPushButton('nmap -sS', self)
        btn_3.clicked.connect(lambda: self.portScan('-sS'))
        ...
        self.worker = Worker(self.portScan, '')
        self.worker.finished.connect(self.on_finished)
        self.worker.work_error.connect(self.on_error_occurred)
        self.worker.work_progress.connect(self.prg_bar.setValue)
        ...
        central_layout.addWidget(self.prg_bar, 1, 0, 1, 3)
    ...
    def portScan(self, argv: str):
        nm = nmap.PortScanner()
        nm.scan(self.myDevice.get_cidrAddress(), arguments=argv)
        print(nm)
