...
SLOT_REGISTRY = {
    "newFile": lambda parent: print("New File"),
    "open_project": lambda parent: print("Open Project"),
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        change_title_btn = QPushButton("Change Title", self)
        change_title_btn.clicked.connect(self.change_title_dialog)
        layout.addWidget(change_title_btn)

        # close_btn = QPushButton("Close", self)
        # close_btn.clicked.connect(self.close)
        # layout.addWidget(close_btn)

    def change_title_dialog(self):
    ...
    def quit(self):
        ...
        self.destroy()
        # arrête et détruit tous les processus liés à l'application
        QApplication.quit()
